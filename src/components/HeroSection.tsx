  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl xl:text-hero font-bold text-coffee-500 mb-6 animate-fade-in">
          O melhor café que você poderia tomar
        </h1>
        
        <p className="font-inter text-lg sm:text-xl lg:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in">
          Descubra o sabor único do nosso café artesanal, preparado com grãos selecionados 
          e torrefação especial para uma experiência inesquecível.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
          ...
          <button
            ...
            className="border-2 border-coffee-500 text-coffee-500 hover:bg-coffee-500 hover:text-white font-inter font-semibold px-8 py-4 rounded-lg text-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-coffee-500 focus:ring-offset-2"
          >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <ArrowDown className="h-6 w-6 text-coffee-500" aria-hidden="true" />
        </div>
      </div>
    </section>
  );
